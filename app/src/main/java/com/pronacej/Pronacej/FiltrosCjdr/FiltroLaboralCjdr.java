...
import com.pronacej.Pronacej.ResultadosCjrd.ResultadosLaboralIngresoCjdr;
...
public class FiltroLaboralCjdr extends AppCompatActivity {
    ...
    private void mostrarMensajeNoData() {
        runOnUiThread(() -> Toast.makeText(FiltroLaboralCjdr.this, "No existe data en esa fecha", Toast.LENGTH_SHORT).show());
    }

    private void mostrarMensajeError(String mensaje) {
        runOnUiThread(() -> Toast.makeText(FiltroLaboralCjdr.this, mensaje, Toast.LENGTH_SHORT).show());
    }
