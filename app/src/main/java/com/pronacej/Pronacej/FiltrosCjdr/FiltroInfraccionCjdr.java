...
import com.pronacej.Pronacej.ResultadosCjrd.ResultadosDelitoCjdr;
...
public class FiltroInfraccionCjdr extends AppCompatActivity {
    ...
    private void mostrarMensajeNoData() {
        runOnUiThread(() -> Toast.makeText(FiltroInfraccionCjdr.this, "No existe data en esa fecha", Toast.LENGTH_SHORT).show());
    }

    private void mostrarMensajeError(String mensaje) {
        runOnUiThread(() -> Toast.makeText(FiltroInfraccionCjdr.this, mensaje, Toast.LENGTH_SHORT).show());
    }
