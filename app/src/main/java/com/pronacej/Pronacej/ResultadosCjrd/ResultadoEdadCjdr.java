        ...
        if (datosJson != null) {
            try {
                ...
                if (jsonArray.length() > 0) {
                    ...
                    Toast.makeText(ResultadoEdadCjdr.this, "No se encontraron datos para mostrar", Toast.LENGTH_SHORT).show();
                }
            ...
            Toast.makeText(ResultadoEdadCjdr.this, "No se recibieron datos para mostrar", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        while (keys.hasNext()) {
            ...
            if (!key.equals("estado_ing")) {
                ...
                if (i < textViewsPorcentaje.length && i < textViewsNombre.length) {
                    textViewsPorcentaje[i].setText(String.format("%d", Math.round(valor))+" de");
