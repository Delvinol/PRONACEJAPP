...
import com.pronacej.Pronacej.ResultadosSoa.ResultadoCentroEducativoSoa;
...
public class FiltroEducativaSoa extends AppCompatActivity {
    ...
    private void mostrarMensajeNoData() {
        runOnUiThread(() -> Toast.makeText(FiltroEducativaSoa.this, "No existe data en esa fecha", Toast.LENGTH_SHORT).show());
    }

    private void mostrarMensajeError(String mensaje) {
        runOnUiThread(() -> Toast.makeText(FiltroEducativaSoa.this, mensaje, Toast.LENGTH_SHORT).show());
    }
