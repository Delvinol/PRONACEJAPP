...
import com.pronacej.Pronacej.ResultadosSoa.ResultadoEdadSoa;
...
public class FiltroEdadSoa extends AppCompatActivity {
    ...
    private CheckBox cbIncluirEstadoIng, cbIncluirEstadoAten;
    ...
    private void llamarEndPoint() {
        ...
        call.enqueue(new Callback<List<Map<String, Object>>>() {
            ...
            public void onResponse(Call<List<Map<String, Object>>> call, Response<List<Map<String, Object>>> response) {
                ...
                if (response.isSuccessful() && response.body() != null && !response.body().isEmpty()) {
                    ...
                    if (contieneDataValida(datos)) {
                        ...
                        Toast.makeText(FiltroEdadSoa.this, "No existe data en esa fecha", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(FiltroEdadSoa.this, "Error al obtener datos", Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onFailure(Call<List<Map<String, Object>>> call, Throwable t) {
                ...
                Toast.makeText(FiltroEdadSoa.this, "Error de conexión", Toast.LENGTH_LONG).show();
            }
        });
    }
