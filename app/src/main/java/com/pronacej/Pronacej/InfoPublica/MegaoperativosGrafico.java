...
public class MegaoperativosGrafico extends AppCompatActivity {
    ...
    private List<Map<String, Object>> megaOperativosData;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.resultado_megaoperativos);
        Button ButtonBack = findViewById(R.id.buttonBack);
        Button ButtonHome = findViewById(R.id.buttonHome);

        ButtonHome.setOnClickListener(v -> {
            Intent intentHome = new Intent(MegaoperativosGrafico.this, CategoriaMenu.class);
    ...
    private void fetchMegaOperativosData() {
        SeguridadService service = Apis.getSeguridadService();
        Call<List<Map<String, Object>>> call = service.getMegaOperativos();

        call.enqueue(new Callback<List<Map<String, Object>>>() {
            @Override
            public void onResponse(Call<List<Map<String, Object>>> call, Response<List<Map<String, Object>>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    megaOperativosData = response.body();
                    setupChart();
                } else {
                    Toast.makeText(MegaoperativosGrafico.this, "Error al obtener datos", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<Map<String, Object>>> call, Throwable t) {
                Toast.makeText(MegaoperativosGrafico.this, "Error de conexión", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void setupChart() {
        ...
        for (int i = 0; i < megaOperativosData.size(); i++) {
            Map<String, Object> reyerta = megaOperativosData.get(i);
        ...
        BarDataSet dataSet = new BarDataSet(entries, "Mega Operativos Totales por cada centro CJDR");
        dataSet.setColor(ContextCompat.getColor(this, R.color.Pronacej7));
        ...
        xAxis.setValueFormatter(new ValueFormatter() {
            @Override
            public String getFormattedValue(float value) {
                if (value >= 0 && value < megaOperativosData.size()) {
                    return (String) megaOperativosData.get((int) value).get("centro_juvenil");
                }
                return "";
            }
        });
        ...
        xAxis.setLabelCount(megaOperativosData.size());
