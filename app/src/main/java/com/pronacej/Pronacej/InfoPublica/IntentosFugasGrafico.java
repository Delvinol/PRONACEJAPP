...
public class IntentosFugasGrafico extends AppCompatActivity {

    private HorizontalBarChart barChart;
    private TextView textViewTotalFugas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.resultado_operativo_control);

        barChart = findViewById(R.id.barChart);
        textViewTotalFugas = findViewById(R.id.textViewTotalCantidad1);
        ...
        buttonHome.setOnClickListener(v -> {
            Intent intentHome = new Intent(IntentosFugasGrafico.this, CategoriaMenu.class);
    ...
    private void fetchFugasData() {
        SeguridadService service = Apis.getSeguridadService();
        Call<List<Map<String, Object>>> call = service.getFugas();
        ...
        call.enqueue(new Callback<List<Map<String, Object>>>() {
            ...
            public void onResponse(Call<List<Map<String, Object>>> call, Response<List<Map<String, Object>>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(IntentosFugasGrafico.this, "Error al obtener datos", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<Map<String, Object>>> call, Throwable t) {
                Toast.makeText(IntentosFugasGrafico.this, "Error de conexión", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void setupChart(List<Map<String, Object>> data) {
        ...
        textViewTotalFugas.setText(String.valueOf(totalFugas));

        BarDataSet dataSet = new BarDataSet(entries, "Intentos de Fugas por Centro Juvenil");
