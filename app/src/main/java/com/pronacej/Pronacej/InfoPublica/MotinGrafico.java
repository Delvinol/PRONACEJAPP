...
public class MotinGrafico extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.resultado_motin_control);
        ...
        ButtonHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentHome = new Intent(MotinGrafico.this, CategoriaMenu.class);
    ...
    private void setupChart(int yearIndex) {
        ...
        BarDataSet dataSet = new BarDataSet(entries, "Motín por Centro");
