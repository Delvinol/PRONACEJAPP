...
public class RecapturasGrafico extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.resultado_recaptura_control);
        ...
        ButtonHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentHome = new Intent(RecapturasGrafico.this, CategoriaMenu.class);
    ...
    private void setupChart(int yearIndex) {
        ...
        BarDataSet dataSet = new BarDataSet(entries, "Recaptura por Centro");
